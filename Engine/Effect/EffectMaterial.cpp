...
/// 静的メンバ変数の実体
/// </summary>
ID3D12Device* EffectMaterial::device_ = nullptr;

void EffectMaterial::StaticInitialize(ID3D12Device* device) { device_ = device; }

EffectMaterial* EffectMaterial::Create() {
	EffectMaterial* instance = new EffectMaterial;
...
void EffectMaterial::LoadTexture(
